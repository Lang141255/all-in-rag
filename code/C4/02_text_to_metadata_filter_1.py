...
from langchain_huggingface import HuggingFacceEmbeddings
import logging
...
try:
    ...
    for doc in docs:
        ...
        metadata = {
            ...
            'anthor': original.get('owner', {}).get('name', '未知作者'),
...
# 2. 创建向量存储
embed_model = HuggingFacceEmbeddings(model_name="BAAI/bge-small-zh-v1.5")
...
retriever = SelfQueryRetriever.from_llm(
    ...
    document_content = "记录视频标题、作者、观看次数等信息的视频元数据",
